class Rope
  ...
  this.pointA = pointA;
  this.body = Composites.chain(rects, 0.1, 0, -0.6, 0, {stiffness: 0.2, length:0/*num donde se colgara la fruta apartir de que recta esta se omite si en el scketch  anexo codigo -> Matter.Composite.add(rope.body,fruit);*/, render: {type: 'line'}});
